...
class ClientImpl {
    ...
    : m_engine(engine)
    , m_check_sequencer(m_engine.define("mobject_check_sequencer"))
    , m_say_hello(m_engine.define("mobject_say_hello").disable_response())
    , m_compute_sum(m_engine.define("mobject_compute_sum"))
    {}
