 ...
 */
#ifndef __MOBJECT_UUID_UTIL_HPP
#define __MOBJECT_UUID_UTIL_HPP
...
namespace std {
    ...
    /**
     * @brief Specialization of std::hash for mobject::UUID
     */
    template<>
    struct hash<mobject::UUID> 
    {
        size_t operator()(const mobject::UUID& id) const
        {
            return id.hash();
        }
    };
